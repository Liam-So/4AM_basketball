                        ...
                        {coaches.map((coach) => (
                            <Grid  key={coach.id} item xs={12} sm={6} md={4} lg={4}>
                                <Card className={classes.root}>
                                    ...
                                    <Typography variant='h5' gutterBottom style={{color: '#f00946', fontFamily: 'Lato'}}>
                                        {coach.name}
                                    </Typography>
                                    <Typography variant="body2" color="textSecondary" style={{fontFamily: 'Lato'}}>{coach.description}</Typography>
                                </Card>
                            </Grid>
                        ))}
                        </Grid>
